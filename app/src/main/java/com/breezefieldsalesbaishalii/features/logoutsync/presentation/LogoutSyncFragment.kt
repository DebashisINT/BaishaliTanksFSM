package com.breezefieldsalesbaishalii.features.logoutsync.presentation
...
import com.breezefieldsalesbaishalii.app.AppDatabase
import com.breezefieldsalesbaishalii.app.NetworkConstant
...
import com.breezefieldsalesbaishalii.app.utils.Toaster
...
import com.breezefieldsalesbaishalii.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezefieldsalesbaishalii.features.billing.api.AddBillingRepoProvider
import com.breezefieldsalesbaishalii.features.billing.model.AddBillingInputParamsModel
...
import com.breezefieldsalesbaishalii.features.dashboard.presentation.ReasonDialog
...
import com.breezefieldsalesbaishalii.features.document.model.AddEditDocumentInputParams
import com.breezefieldsalesbaishalii.features.document.model.DocumentAttachmentModel
...
import com.breezefieldsalesbaishalii.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.breezefieldsalesbaishalii.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.breezefieldsalesbaishalii.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezefieldsalesbaishalii.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezefieldsalesbaishalii.features.orderhistory.model.*
...
import com.breezefieldsalesbaishalii.features.quotation.model.AddQuotInputModel
import com.breezefieldsalesbaishalii.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldsalesbaishalii.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezefieldsalesbaishalii.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezefieldsalesbaishalii.features.stockAddCurrentStock.ShopAddCurrentStockList
import com.breezefieldsalesbaishalii.features.stockAddCurrentStock.ShopAddCurrentStockRequest
import com.breezefieldsalesbaishalii.features.stockAddCurrentStock.api.ShopAddStockProvider
import com.breezefieldsalesbaishalii.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.breezefieldsalesbaishalii.features.timesheet.model.AddTimeSheetInputModel
import com.breezefieldsalesbaishalii.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezefieldsalesbaishalii.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezefieldsalesbaishalii.features.viewAllOrder.model.AddOrderInputProductList
import com.breezefieldsalesbaishalii.mappackage.SendBrod
import com.breezefieldsalesbaishalii.widgets.AppCustomTextView
import com.breezefieldsalesbaishalii.MonitorService
import com.breezefieldsalesbaishalii.MySingleton
...
import com.breezefieldsalesbaishalii.features.addshop.presentation.ShopExtraContactReq
...
import com.breezefieldsalesbaishalii.features.login.model.GetConcurrentUserResponse
import com.breezefieldsalesbaishalii.features.login.model.WhatsappApiData
import com.breezefieldsalesbaishalii.features.performance.model.Gps_status_list
import com.breezefieldsalesbaishalii.features.performance.model.UpdateGpsInputListParamsModel
import com.breezefieldsalesbaishalii.features.returnsOrder.ReturnProductList
import com.breezefieldsalesbaishalii.features.returnsOrder.ReturnRequest
import com.breezefieldsalesbaishalii.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesbaishaliilogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesbaishaliilogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesbaishaliilogsample/log.zip").path);
