...
import com.breezefieldsalesbaishalii.*
import com.breezefieldsalesbaishalii.R
import com.breezefieldsalesbaishalii.app.*
import com.breezefieldsalesbaishalii.app.NewFileUtils.browseDocuments
import com.breezefieldsalesbaishalii.app.NewFileUtils.browsePDFDocuments
import com.breezefieldsalesbaishalii.app.NewFileUtils.getExtension
import com.breezefieldsalesbaishalii.app.domain.*
import com.breezefieldsalesbaishalii.app.types.DashboardType
import com.breezefieldsalesbaishalii.app.types.FragType
import com.breezefieldsalesbaishalii.app.types.TopBarConfig
import com.breezefieldsalesbaishalii.app.uiaction.DisplayAlert
import com.breezefieldsalesbaishalii.app.utils.*
import com.breezefieldsalesbaishalii.app.utils.AppUtils.Companion.isProfile
import com.breezefieldsalesbaishalii.base.BaseResponse
import com.breezefieldsalesbaishalii.base.presentation.BaseActivity
import com.breezefieldsalesbaishalii.base.presentation.BaseFragment
import com.breezefieldsalesbaishalii.features.NewQuotation.*
import com.breezefieldsalesbaishalii.features.NewQuotation.api.GetQuotRegProvider
import com.breezefieldsalesbaishalii.features.NewQuotation.model.ViewDetailsQuotResponse
import com.breezefieldsalesbaishalii.features.SearchLocation.SearchLocationFragment
import com.breezefieldsalesbaishalii.features.SearchLocation.locationInfoModel
import com.breezefieldsalesbaishalii.features.TA.ViewAllTAListFragment
import com.breezefieldsalesbaishalii.features.achievement.AchievementFragment
import com.breezefieldsalesbaishalii.features.activities.presentation.*
import com.breezefieldsalesbaishalii.features.addAttendence.*
import com.breezefieldsalesbaishalii.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.breezefieldsalesbaishalii.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.breezefieldsalesbaishalii.features.addAttendence.model.GetReportToFCMResponse
import com.breezefieldsalesbaishalii.features.addAttendence.model.GetReportToResponse
import com.breezefieldsalesbaishalii.features.addAttendence.model.Leave_list_Response
import com.breezefieldsalesbaishalii.features.addorder.presentation.AddOrderFragment
...
import com.breezefieldsalesbaishalii.features.addshop.presentation.AddShopFragment
import com.breezefieldsalesbaishalii.features.addshop.presentation.OTPVerificationDialog
import com.breezefieldsalesbaishalii.features.addshop.presentation.ScanImageFragment
import com.breezefieldsalesbaishalii.features.addshop.presentation.ShowCardDetailsDialog
import com.breezefieldsalesbaishalii.features.alarm.model.AlarmData
import com.breezefieldsalesbaishalii.features.alarm.presetation.AttendanceReportFragment
import com.breezefieldsalesbaishalii.features.alarm.presetation.PerformanceReportFragment
import com.breezefieldsalesbaishalii.features.alarm.presetation.VisitReportDetailsFragment
import com.breezefieldsalesbaishalii.features.alarm.presetation.VisitReportFragment
import com.breezefieldsalesbaishalii.features.attendance.AttendanceFragment
import com.breezefieldsalesbaishalii.features.attendance.api.AttendanceRepositoryProvider
import com.breezefieldsalesbaishalii.features.attendance.model.AttendanceRequest
import com.breezefieldsalesbaishalii.features.attendance.model.AttendanceResponse
import com.breezefieldsalesbaishalii.features.averageshop.presentation.AverageShopFragment
import com.breezefieldsalesbaishalii.features.avgorder.presentation.AverageOrderFragment
import com.breezefieldsalesbaishalii.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.breezefieldsalesbaishalii.features.beatCustom.TeamBeatListFragment
import com.breezefieldsalesbaishalii.features.billing.presentation.AddBillingFragment
import com.breezefieldsalesbaishalii.features.billing.presentation.BillingDetailsFragment
import com.breezefieldsalesbaishalii.features.billing.presentation.BillingListFragment
import com.breezefieldsalesbaishalii.features.changepassword.presentation.ChangePasswordDialog
import com.breezefieldsalesbaishalii.features.chat.model.ChatListDataModel
import com.breezefieldsalesbaishalii.features.chat.model.ChatUserDataModel
import com.breezefieldsalesbaishalii.features.chat.model.GroupUserDataModel
import com.breezefieldsalesbaishalii.features.chat.presentation.*
import com.breezefieldsalesbaishalii.features.chatbot.presentation.ChatBotFragment
import com.breezefieldsalesbaishalii.features.chatbot.presentation.ChatBotShopListFragment
import com.breezefieldsalesbaishalii.features.chatbot.presentation.ReportsFragment
import com.breezefieldsalesbaishalii.features.chatbot.presentation.SelectLanguageDialog
import com.breezefieldsalesbaishalii.features.commondialog.presentation.CommonDialog
import com.breezefieldsalesbaishalii.features.commondialog.presentation.CommonDialogClickListener
import com.breezefieldsalesbaishalii.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.breezefieldsalesbaishalii.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.breezefieldsalesbaishalii.features.commondialogsinglebtn.OnDialogClickListener
import com.breezefieldsalesbaishalii.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.breezefieldsalesbaishalii.features.contacts.ContactDtls
import com.breezefieldsalesbaishalii.features.contacts.ContactGr
import com.breezefieldsalesbaishalii.features.contacts.ContactsAddFrag
import com.breezefieldsalesbaishalii.features.contacts.ContactsFrag
import com.breezefieldsalesbaishalii.features.contacts.SchedulerViewFrag
import com.breezefieldsalesbaishalii.features.contacts.SchedulerAddFormFrag
import com.breezefieldsalesbaishalii.features.contacts.TemplateAddFrag
import com.breezefieldsalesbaishalii.features.contacts.TemplateViewFrag
import com.breezefieldsalesbaishalii.features.dailyPlan.prsentation.AllShopListFragment
import com.breezefieldsalesbaishalii.features.dailyPlan.prsentation.DailyPlanListFragment
import com.breezefieldsalesbaishalii.features.dailyPlan.prsentation.PlanDetailsFragment
import com.breezefieldsalesbaishalii.features.damageProduct.ShopDamageProductListFrag
import com.breezefieldsalesbaishalii.features.damageProduct.ShopDamageProductSubmitFrag
import com.breezefieldsalesbaishalii.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.breezefieldsalesbaishalii.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.breezefieldsalesbaishalii.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.breezefieldsalesbaishalii.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.breezefieldsalesbaishalii.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.breezefieldsalesbaishalii.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.breezefieldsalesbaishalii.features.dashboard.presentation.model.ContentListResponseModel
import com.breezefieldsalesbaishalii.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.breezefieldsalesbaishalii.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.breezefieldsalesbaishalii.features.device_info.presentation.DeviceInfoListFragment
import com.breezefieldsalesbaishalii.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.breezefieldsalesbaishalii.features.document.DocumentRepoFeatureNewFragment
import com.breezefieldsalesbaishalii.features.document.presentation.DocumentListFragment
import com.breezefieldsalesbaishalii.features.document.presentation.DocumentTypeListFragment
import com.breezefieldsalesbaishalii.features.document.presentation.OpenFileWebViewFragment
import com.breezefieldsalesbaishalii.features.dymanicSection.presentation.AddDynamicFragment
import com.breezefieldsalesbaishalii.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezefieldsalesbaishalii.features.dymanicSection.presentation.DynamicListFragment
import com.breezefieldsalesbaishalii.features.dymanicSection.presentation.EditDynamicFragment
import com.breezefieldsalesbaishalii.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezefieldsalesbaishalii.features.home.presentation.HomeFragment
import com.breezefieldsalesbaishalii.features.homelocation.presentation.HomeLocationFragment
import com.breezefieldsalesbaishalii.features.homelocation.presentation.HomeLocationMapFragment
import com.breezefieldsalesbaishalii.features.know_your_state.KnowYourStateFragment
import com.breezefieldsalesbaishalii.features.lead.LeadFrag
import com.breezefieldsalesbaishalii.features.lead.ViewLeadFrag
import com.breezefieldsalesbaishalii.features.leaderboard.LeaderBoardFrag
import com.breezefieldsalesbaishalii.features.leaveapplynew.LeaveHome
import com.breezefieldsalesbaishalii.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.breezefieldsalesbaishalii.features.localshops.LocalShopListFragment
import com.breezefieldsalesbaishalii.features.localshops.LocalShopListMapFragment
import com.breezefieldsalesbaishalii.features.localshops.NearByShopsMapFragment
import com.breezefieldsalesbaishalii.features.location.*
import com.breezefieldsalesbaishalii.features.location.api.LocationRepoProvider
import com.breezefieldsalesbaishalii.features.location.model.*
import com.breezefieldsalesbaishalii.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.breezefieldsalesbaishalii.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.breezefieldsalesbaishalii.features.login.ShopFeedbackEntity
import com.breezefieldsalesbaishalii.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.breezefieldsalesbaishalii.features.login.presentation.LoginActivity
import com.breezefieldsalesbaishalii.features.logout.presentation.api.LogoutRepositoryProvider
import com.breezefieldsalesbaishalii.features.logoutsync.presentation.LogoutSyncFragment
import com.breezefieldsalesbaishalii.features.marketAssist.MarketAssistTabFrag
import com.breezefieldsalesbaishalii.features.marketAssist.ShopDtlsMarketAssistFrag
import com.breezefieldsalesbaishalii.features.marketAssist.ShopListMarketAssistFrag
import com.breezefieldsalesbaishalii.features.marketing.presentation.MarketingPagerFragment
import com.breezefieldsalesbaishalii.features.meetinglist.prsentation.MeetingListFragment
import com.breezefieldsalesbaishalii.features.member.MapViewForTeamFrag
import com.breezefieldsalesbaishalii.features.member.model.TeamLocDataModel
import com.breezefieldsalesbaishalii.features.member.model.TeamShopListDataModel
import com.breezefieldsalesbaishalii.features.member.presentation.*
import com.breezefieldsalesbaishalii.features.menuBeat.MenuBeatFrag
import com.breezefieldsalesbaishalii.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezefieldsalesbaishalii.features.micro_learning.presentation.MicroLearningListFragment
import com.breezefieldsalesbaishalii.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezefieldsalesbaishalii.features.myallowancerequest.MyallowanceRequestFragment
import com.breezefieldsalesbaishalii.features.myjobs.model.CustomerDataModel
import com.breezefieldsalesbaishalii.features.myjobs.presentation.*
import com.breezefieldsalesbaishalii.features.myorder.presentation.MyOrderListFragment
import com.breezefieldsalesbaishalii.features.myprofile.presentation.MyProfileFragment
import com.breezefieldsalesbaishalii.features.nearbyshops.api.ShopListRepositoryProvider
import com.breezefieldsalesbaishalii.features.nearbyshops.model.ShopData
import com.breezefieldsalesbaishalii.features.nearbyshops.model.ShopListResponse
import com.breezefieldsalesbaishalii.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.breezefieldsalesbaishalii.features.nearbyshops.presentation.BeatListFragment
import com.breezefieldsalesbaishalii.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezefieldsalesbaishalii.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezefieldsalesbaishalii.features.nearbyshops.presentation.ShopCallHisFrag
import com.breezefieldsalesbaishalii.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezefieldsalesbaishalii.features.newcollection.CollectionDetailsStatusFragment
import com.breezefieldsalesbaishalii.features.newcollection.CollectionShopListFragment
import com.breezefieldsalesbaishalii.features.newcollection.NewCollectionListFragment
import com.breezefieldsalesbaishalii.features.newcollectionreport.*
import com.breezefieldsalesbaishalii.features.notification.NotificationFragment
import com.breezefieldsalesbaishalii.features.orderList.NewDateWiseOrderListFragment
import com.breezefieldsalesbaishalii.features.orderList.NewOrderListFragment
import com.breezefieldsalesbaishalii.features.orderList.OrderListFragment
import com.breezefieldsalesbaishalii.features.orderdetail.presentation.OrderDetailFragment
import com.breezefieldsalesbaishalii.features.orderhistory.ActivityMapFragment
import com.breezefieldsalesbaishalii.features.orderhistory.OrderhistoryFragment
import com.breezefieldsalesbaishalii.features.orderhistory.TimeLineFragment
import com.breezefieldsalesbaishalii.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezefieldsalesbaishalii.features.orderhistory.model.FetchLocationRequest
import com.breezefieldsalesbaishalii.features.orderhistory.model.FetchLocationResponse
import com.breezefieldsalesbaishalii.features.orderhistory.model.LocationData
import com.breezefieldsalesbaishalii.features.pendinglocationinout.PendingOutLocationFrag
import com.breezefieldsalesbaishalii.features.performance.GpsStatusFragment
import com.breezefieldsalesbaishalii.features.performance.PerformanceFragment
import com.breezefieldsalesbaishalii.features.performance.api.UpdateGpsStatusRepoProvider
import com.breezefieldsalesbaishalii.features.performance.model.UpdateGpsInputParamsModel
import com.breezefieldsalesbaishalii.features.performanceAPP.OwnPerformanceFragment
import com.breezefieldsalesbaishalii.features.performanceAPP.PerformanceAppFragment
import com.breezefieldsalesbaishalii.features.performanceAPP.allPerformanceFrag
import com.breezefieldsalesbaishalii.features.permissionList.ViewPermissionFragment
import com.breezefieldsalesbaishalii.features.photoReg.*
import com.breezefieldsalesbaishalii.features.privacypolicy.PrivacypolicyWebviewFrag
import com.breezefieldsalesbaishalii.features.quotation.presentation.*
import com.breezefieldsalesbaishalii.features.reimbursement.presentation.*
import com.breezefieldsalesbaishalii.features.report.presentation.*
import com.breezefieldsalesbaishalii.features.returnsOrder.*
import com.breezefieldsalesbaishalii.features.settings.presentation.SettingsFragment
import com.breezefieldsalesbaishalii.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.breezefieldsalesbaishalii.features.shopdetail.presentation.*
import com.breezefieldsalesbaishalii.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldsalesbaishalii.features.stock.StockDetailsFragment
import com.breezefieldsalesbaishalii.features.stock.StockListFragment
import com.breezefieldsalesbaishalii.features.stockAddCurrentStock.AddShopStockFragment
import com.breezefieldsalesbaishalii.features.stockAddCurrentStock.UpdateShopStockFragment
import com.breezefieldsalesbaishalii.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezefieldsalesbaishalii.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.breezefieldsalesbaishalii.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezefieldsalesbaishalii.features.stockCompetetorStock.CompetetorStockFragment
import com.breezefieldsalesbaishalii.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezefieldsalesbaishalii.features.survey.SurveyFrag
import com.breezefieldsalesbaishalii.features.survey.SurveyViewDtlsFrag
import com.breezefieldsalesbaishalii.features.survey.SurveyViewFrag
import com.breezefieldsalesbaishalii.features.task.presentation.AddTaskFragment
import com.breezefieldsalesbaishalii.features.task.presentation.CalenderTaskFragment
import com.breezefieldsalesbaishalii.features.task.presentation.EditTaskFragment
import com.breezefieldsalesbaishalii.features.task.presentation.TaskListFragment
import com.breezefieldsalesbaishalii.features.taskManagement.TaskManagementFrag
import com.breezefieldsalesbaishalii.features.taskManagement.ViewTaskManagementFrag
import com.breezefieldsalesbaishalii.features.timesheet.presentation.AddTimeSheetFragment
import com.breezefieldsalesbaishalii.features.timesheet.presentation.EditTimeSheetFragment
import com.breezefieldsalesbaishalii.features.timesheet.presentation.TimeSheetListFragment
import com.breezefieldsalesbaishalii.features.viewAllOrder.CartFragment
import com.breezefieldsalesbaishalii.features.viewAllOrder.OrderTypeListFragment
import com.breezefieldsalesbaishalii.features.viewAllOrder.ViewAllOrderListFragment
import com.breezefieldsalesbaishalii.features.viewAllOrder.ViewCartFragment
import com.breezefieldsalesbaishalii.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.breezefieldsalesbaishalii.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.breezefieldsalesbaishalii.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.breezefieldsalesbaishalii.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.breezefieldsalesbaishalii.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.breezefieldsalesbaishalii.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.breezefieldsalesbaishalii.features.viewPPDDStock.ViewOutstandingFragment
import com.breezefieldsalesbaishalii.features.viewPPDDStock.ViewPPDDListFragment
import com.breezefieldsalesbaishalii.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezefieldsalesbaishalii.features.viewPPDDStock.ViewStockFragment
import com.breezefieldsalesbaishalii.features.weather.presentation.WeatherFragment
import com.breezefieldsalesbaishalii.mappackage.MapActivity
import com.breezefieldsalesbaishalii.mappackage.MapActivityWithoutPath
import com.breezefieldsalesbaishalii.mappackage.SendBrod
import com.breezefieldsalesbaishalii.widgets.AppCustomEditText
import com.breezefieldsalesbaishalii.widgets.AppCustomTextView
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xbreezefieldsalesbaishaliilogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesbaishaliilogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.breezefieldsalesbaishalii/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesbaishaliilogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesbaishaliilogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesbaishaliilogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesbaishaliilogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
